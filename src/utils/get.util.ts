...
export class YtDlpDownloader {
    ...
    public async download(url: string, format = 'best'): Promise<string> {
        ...
        return new Promise((resolve, reject) => {
            ...
            this.ytDlp
                .exec([url, '-f', format, '-o', outputPath, '--no-playlist', '--concurrent-fragments', '1', "cookies", "./.bot/cookies.txt",  "--user-agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/237.84.2.178 Safari/537.36"])
